...
class Searcher:
    ...
    algos = {'Standard': simple_search.__get__(object),
             'Rabin': rabin_karp.__get__(object),
             'KMP': kmp.__get__(object),
             'Aho': aho_korasik.__get__(object),
             'Bauer': bauer_moore.__get__(object)}
